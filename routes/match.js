...
API.createAllMatches = function (req, res, next) {
    ...
    MatchModel.createAllMatch(matches , (err, docs) =>{
        if(err){
            console.log(err)
            res.send({message:err, status:false, docs:0})
        }
        console.log('hello')
        res.send({message:'added successful', status:true, docs:docs})
    })
...
API.getAllMatches = function(req, res, next){
    try {
        ...
        MatchModel.getMatch(where, (err, matches)=>{
            if(err){
                console.log(err)
                res.send({message:err, status:false, docs:[]})
            }
            res.send({message:'added successful', status:true, docs:matches.length})
        })
    } catch (error) {
        console.log(error)
        res.send({})
...
API.futureMatchPrediction = function(req, res, next){
    try {
        ...
        MatchModel.getMatch(where, (err, matches)=>{
            ...
            res.send({message:'successful', status:true, docs:matches.length})
        })
    } catch (error) {
        console.log(error)
        res.send({})
...
API.getAllSeasons = function(req, res, next){
    try {
        ...
        MatchModel.getSeasons({}, (err, seasons)=>{
            ...
            res.send({message:'successful', status:true, docs:seasons})
        })
    } catch (error) {
        console.log(error)
        res.send({})
